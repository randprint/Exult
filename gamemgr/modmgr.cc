...
ModManager::ModManager (const string& name, const string& menu, bool needtitle)
	...
	if (!strcmp(static_identity,"ULTIMA7"))
		...
		expansion = false;
		static_dir = "uda:/exult/ultima7/static";
		}
		...
		expansion = false;
		static_dir = "uda:/exult/serpent/static";
		}
...
void ModManager::get_game_paths(const string& game_path)
	...
	add_system_path("<" + path_prefix + "_SAVEGAME>", "uda:/exult/savegame");
...
GameManager::GameManager()
	...
	if (ssind >= 0)
		...
		// Sane defaults.
	add_system_path("<ULTIMA7_STATIC>", "uda:/exult/ultima7/static");
	add_system_path("<SERPENT_STATIC>", "uda:/exult/serpent/static");
