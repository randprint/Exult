...
pkgdatadir = $(datadir)/exult
pkgincludedir = $(includedir)/exult
pkglibdir = $(libdir)/exult
pkglibexecdir = $(libexecdir)/exult
...
bin_PROGRAMS = exult$(EXEEXT)
subdir = .
DIST_COMMON = README $(am__configure_deps) $(noinst_HEADERS) \
	$(srcdir)/Info.plist.in $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/exult.spec.in $(top_srcdir)/configure AUTHORS \
...
CONFIG_CLEAN_FILES = exult.spec Info.plist
CONFIG_CLEAN_VPATH_FILES =
am__installdirs = "$(DESTDIR)$(bindir)"
PROGRAMS = $(bin_PROGRAMS)
am_exult_OBJECTS = actions.$(OBJEXT) actorio.$(OBJEXT) \
	actors.$(OBJEXT) args.$(OBJEXT) browser.$(OBJEXT) \
	cheat.$(OBJEXT) cheat_screen.$(OBJEXT) combat.$(OBJEXT) \
	delobjs.$(OBJEXT) dir.$(OBJEXT) drag.$(OBJEXT) \
	effects.$(OBJEXT) exult.$(OBJEXT) exultmenu.$(OBJEXT) \
	game.$(OBJEXT) gameclk.$(OBJEXT) gamedat.$(OBJEXT) \
	gamemap.$(OBJEXT) gamerend.$(OBJEXT) gamewin.$(OBJEXT) \
	istring.$(OBJEXT) keys.$(OBJEXT) keyactions.$(OBJEXT) \
	menulist.$(OBJEXT) monsters.$(OBJEXT) mouse.$(OBJEXT) \
	npcnear.$(OBJEXT) npctime.$(OBJEXT) palette.$(OBJEXT) \
	party.$(OBJEXT) paths.$(OBJEXT) readnpcs.$(OBJEXT) \
	schedule.$(OBJEXT) shapeid.$(OBJEXT) tqueue.$(OBJEXT) \
	txtscroll.$(OBJEXT) version.$(OBJEXT) xdrag.$(OBJEXT)
exult_OBJECTS = $(am_exult_OBJECTS)
am__DEPENDENCIES_1 =
DEFAULT_INCLUDES = -I.
...
LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) \
	...
	$(LDFLAGS) -o $@
SOURCES = $(exult_SOURCES)
DIST_SOURCES = $(exult_SOURCES)
...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = files conf data shapes imagewin flic pathfinder usecode \
	audio gumps objs server gamemgr mapedit desktop docs \
	content
...
ACLOCAL = ${SHELL} /home/pos/Desktop/exult/missing --run aclocal-1.11
AMTAR = ${SHELL} /home/pos/Desktop/exult/missing --run tar
AR = xenon-ar
AUTOCONF = ${SHELL} /home/pos/Desktop/exult/missing --run autoconf
AUTOHEADER = ${SHELL} /home/pos/Desktop/exult/missing --run autoheader
AUTOMAKE = ${SHELL} /home/pos/Desktop/exult/missing --run automake-1.11
AWK = gawk
CC = xenon-gcc
CCDEPMODE = depmode=gcc3
CFLAGS =  -MP -g -O2 $(INCLUDE) -m32 -mcpu=cell -mtune=cell \
    ...
    -mhard-float -DSAFE_CONSOLE_STREAMS -DXENON -DLIBXENON -DBYTE_ORDER=1 -DBIG_ENDIAN=1 -DLITTLE_ENDIAN=0 \
     /usr/local/xenon/usr/lib/libxenon.a -L/usr/local/xenon/xenon/lib/32/ \
     -T/usr/local/xenon/app.lds -u read -u _start -u exc_base -L/usr/local/xenon/usr/lib \
     -I/usr/local/xenon/usr/include -Wall
CPP = xenon-gcc -E
CPPFLAGS = 
CXX = xenon-g++
CXXCPP = xenon-g++ -E
CXXDEPMODE = depmode=gcc3
CXXFLAGS =  -MP -m32 -g -O2 -mcpu=cell -mtune=cell -fno-tree-vectorize \
    -fno-tree-slp-vectorize -ftree-vectorizer-verbose=1 -fuse-linker-plugin \
    -maltivec -mabi=altivec -fno-pic -mpowerpc64 -mhard-float \
    -DSAFE_CONSOLE_STREAMS -DXENON -DLIBXENON -DUSE_MT32EMU_MIDI -UUSE_TIMIDITY_MIDI \
    -DXENON -DBYTE_ORDER=1 -DBIG_ENDIAN=1 -DLITTLE_ENDIAN=0 -Wall -fsigned-char \
    -mcpu=cell -mtune=cell -m32 -fno-pic /usr/local/xenon/usr/lib/libxenon.a \
    -L/usr/local/xenon/xenon/lib/32/ -T/usr/local/xenon/app.lds -u read -u _start -u exc_base \
    -L/usr/local/xenon/usr/lib -I/usr/local/xenon/usr/include
CYGPATH_W = echo
DEBUG_FLAGS = 
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
EXEEXT = 
EXE_TARGET = exult
EXULT_DATADIR = ${datarootdir}/exult
FGREP = /bin/grep -F
FREETYPE2_INCLUDES = -I/usr/local/include/freetype2 -I/usr/local/include
FREETYPE2_LIBS = -L/usr/local/lib -lfreetype -lz
FT2CONFIG = /usr/local/bin/freetype-config
GIMPTOOL = 
GIMP_INCLUDES = 
GIMP_LIBS = 
GIMP_PLUGIN_PREFIX = 
...
LDFLAGS = -m32 -L/usr/local/xenon/xenon/lib/32/ -T/usr/local/xenon/app.lds -L/usr/local/xenon/usr/lib
LEX = flex
LEXLIB = 
...
MAKEINFO = ${SHELL} /home/pos/Desktop/exult/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
OBJEXT = o
OGG_CFLAGS =  
OGG_LIBS = -lvorbisfile -lvorbis -lm -logg  
OPENGL_LIBS = 
OSX_CODE_SIGNATURE = 
OTOOL = 
OTOOL64 = 
...
SHELL = /bin/bash
STRIP = xenon-strip
SYSLIBS = -lfat -lbz2 -lz -lxenon -lglob -lc -lm -lstdc++
VERSION = 1.5.0svn
VORBISENC_LIBS = 
VORBISFILE_LIBS = 
VORBIS_CFLAGS = 
...
YFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /home/pos/Desktop/exult
abs_srcdir = /home/pos/Desktop/exult
abs_top_builddir = /home/pos/Desktop/exult
abs_top_srcdir = /home/pos/Desktop/exult
ac_ct_CC = 
ac_ct_CXX = 
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/pos/Desktop/exult/install-sh
...
exult.spec: $(top_builddir)/config.status $(srcdir)/exult.spec.in
...
clean-binPROGRAMS:
	...
	echo " rm -f" $$list; \
	rm -f $$list
exult$(EXEEXT): $(exult_OBJECTS) $(exult_DEPENDENCIES) 
	@rm -f exult$(EXEEXT)
	$(CXXLINK) $(exult_OBJECTS) $(exult_LDADD) $(LIBS)
...
include ./$(DEPDIR)/actorio.Po
include ./$(DEPDIR)/actors.Po
include ./$(DEPDIR)/args.Po
include ./$(DEPDIR)/browser.Po
include ./$(DEPDIR)/cheat.Po
include ./$(DEPDIR)/cheat_screen.Po
include ./$(DEPDIR)/combat.Po
include ./$(DEPDIR)/delobjs.Po
include ./$(DEPDIR)/dir.Po
include ./$(DEPDIR)/drag.Po
include ./$(DEPDIR)/effects.Po
include ./$(DEPDIR)/exult.Po
include ./$(DEPDIR)/exultmenu.Po
include ./$(DEPDIR)/game.Po
include ./$(DEPDIR)/gameclk.Po
include ./$(DEPDIR)/gamedat.Po
include ./$(DEPDIR)/gamemap.Po
include ./$(DEPDIR)/gamerend.Po
include ./$(DEPDIR)/gamewin.Po
include ./$(DEPDIR)/istring.Po
include ./$(DEPDIR)/keyactions.Po
include ./$(DEPDIR)/keys.Po
include ./$(DEPDIR)/menulist.Po
include ./$(DEPDIR)/monsters.Po
include ./$(DEPDIR)/mouse.Po
include ./$(DEPDIR)/npcnear.Po
include ./$(DEPDIR)/npctime.Po
include ./$(DEPDIR)/palette.Po
include ./$(DEPDIR)/party.Po
include ./$(DEPDIR)/paths.Po
include ./$(DEPDIR)/readnpcs.Po
include ./$(DEPDIR)/schedule.Po
include ./$(DEPDIR)/shapeid.Po
include ./$(DEPDIR)/tqueue.Po
include ./$(DEPDIR)/txtscroll.Po
include ./$(DEPDIR)/version.Po
include ./$(DEPDIR)/xdrag.Po
...
#	$(INSTALL_DATA) AUTHORS $(bundle_name)
#	$(INSTALL_DATA) COPYING $(bundle_name)
#	$(INSTALL_DATA) FAQ $(bundle_name)
#	$(INSTALL_DATA) NEWS $(bundle_name)
#	$(INSTALL_DATA) README $(bundle_name)
#	$(INSTALL_DATA) README.MacOSX $(bundle_name)
...
#	/Developer/Tools/SetFile -a V ./Exult-snapshot/.DS_Store
#	/Developer/Tools/SetFile -a V ./Exult-snapshot/images
#	/Developer/Tools/SetFile -t ttro -c ttxt ./Exult-snapshot/Authors
#	/Developer/Tools/SetFile -t ttro -c ttxt ./Exult-snapshot/License
#	/Developer/Tools/SetFile -t ttro -c ttxt ./Exult-snapshot/News
#	/Developer/Tools/SetFile -t ttro -c ttxt ./Exult-snapshot/ReadMe.MacOSX
#	/Developer/Tools/CpMac -r $(bundle_name) ./Exult-snapshot/
